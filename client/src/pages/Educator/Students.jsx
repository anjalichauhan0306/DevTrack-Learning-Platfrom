    ...
    <div className="min-h-screen bg-[#F8FAFC] font-sans">
      ...
      <div className="bg-[#0a0a23] pt-32 pb-20 px-6 md:px-10">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-indigo-400 font-bold tracking-[0.2em] uppercase text-xs mb-2">
            Educator Dashboard
          </h2>
          ...
          <p className="text-slate-400 text-sm mt-2">
            Manage your students and track their learning milestones in
            real-time.
          </p>
        </div>
      </div>
                  ...
                  return (
                    ...
                    >
                      <td className="px-8 py-6">
                        <div className="font-bold text-slate-800 text-[15px] group-hover:text-indigo-600 transition-colors">
                          {student.name}
                        </div>
                      ...
                      <td className="px-8 py-6">
                        <span
                          className={`text-sm font-bold ${student.lastLogin === "Never" ? "text-rose-500" : "text-slate-600"}`}
                        >
                          {student.lastLogin}
                        </span>
                      </td>
                      <td className="px-8 py-6 text-right">
                        <span
                          className={`inline-flex items-center px-3 py-1 rounded-lg text-[10px] font-black uppercase tracking-wider border ${status.bg} ${status.color} ${status.border}`}
                        >
                          {status.label}
                        </span>
                      </td>

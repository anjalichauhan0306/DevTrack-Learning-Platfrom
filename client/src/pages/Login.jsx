        ...
        <div className="w-full md:w-[55%] p-8 md:p-12 flex flex-col justify-between min-h-full overflow-y-auto md:overflow-hidden custom-scrollbar">
          <div>
            ...
            <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
              ...
              <button
                className="w-full h-12 bg-linear-to-r from-blue-600 to-indigo-600 text-white font-bold rounded-2xl hover:shadow-lg hover:shadow-blue-500/30 transition-all active:scale-[0.97]"
                onClick={handleLogin}
              >

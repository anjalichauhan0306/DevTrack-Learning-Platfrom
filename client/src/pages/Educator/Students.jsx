        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div>
            ...
            <p className="text-slate-400 text-sm mt-3 max-w-md leading-relaxed">
              Analyze student lifetime value, course distribution, and overall
        ...
        <div className="bg-white border border-slate-100 rounded-[2.5rem] shadow-[0_20px_60px_-20px_rgba(0,0,0,0.05)] overflow-hidden">
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50/50 border-b border-slate-100">
                  <th className="px-8 py-6 text-[11px] font-bold text-slate-400 uppercase tracking-[0.1em]">
                    Student Identity
                  </th>
                  <th className="px-8 py-6 text-[11px] font-bold text-slate-400 uppercase tracking-[0.1em]">
                    Academic & Financial
                ...
                {finalStudentsList.map((student, index) => {
                  ...
                  return (
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-2">
                          <div className="flex items-center gap-2">
                            <span className="bg-indigo-50 text-indigo-600 px-2.5 py-1 rounded-lg text-[10px] font-bold flex items-center gap-1.5 w-fit">
                              <GraduationCap size={12} /> {student.courseCount}{" "}
                              Courses
                            </span>
                          </div>
                          <div className="text-[15px] font-black text-slate-900 flex items-center gap-1">
                            ...
                            {student.totalSpend.toLocaleString()}
                          </div>
                        </div>
                      </td>
                      ...
                      <td className="px-8 py-7">
                        <span
                          className={`text-[10px] font-black uppercase px-4 py-1.5 rounded-full border shadow-sm tracking-widest ${tier.color}`}
                        >
                          {tier.label}
                        </span>
                      </td>
          ...
          {finalStudentsList.length === 0 && !loading && (
            <div className="py-24 text-center">
              <div className="text-slate-300 mb-2 font-black text-xl uppercase tracking-widest">
                No Results
              </div>

...
const ReviewPage = () => {
  ...
  return (
    <div className="flex items-center justify-center flex-col">
      <h1 className="md:text-[45px] text-3xl font-semibold text-center mt-7.5 px-5">
        Real Reviews For Real Course
      </h1>

      <span className="lg:w-[50%] md:w-[80%] text-[15px] text-center mt-7.5 mb-7.5 px-5">
        {" "}
        Discover how our MERN stack and UI/UX curriculum has empowered thousands
        of developers to build high-end SaaS applications.
      </span>

          ...
          {!isLoggedIn ? (
            ...
            <div className="flex items-center gap-4">
              ...
              <div ref={dropdownRef} className="relative">
                ...
                >
                  {userData?.photoUrl ? <img src={userData?.photoUrl} className="bg-indigo-600 object-cover text-white size-8 rounded-full flex items-center justify-center font-bold text-xs uppercase" /> : <div className="bg-indigo-600 text-white size-8 rounded-full flex items-center justify-center font-bold text-xs uppercase">{firstLetter}
                  </div>}
                ...
                {isProfileOpen && (
                  <div className="absolute right-0 mt-4 w-52 bg-[#1a1a40] border border-white/10 rounded-xl shadow-2xl py-2 overflow-hidden animate-in fade-in slide-in-from-top-2">
                    ...
                    <Link to="/" className="flex items-center gap-3 px-4 py-2.5 text-sm text-slate-300 hover:bg-white/5 transition"><Settings size={18}/> Settings</Link>

                    ...
                    <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-6 gap-12">
                        ...
                        <div className="lg:col-span-2 grid grid-cols-2 gap-8">
                            <div>
                                ...
                                <ul className="space-y-3 text-sm text-slate-400">
                                    ...
                                    <li><a href="#" className="hover:text-blue-400 transition-colors">Students</a></li>
                            ...
                            <div className="flex flex-col">
                                ...
                                <a 
                                    href="mailto:contact@anjliben.dev" 
                                    className="inline-flex items-center justify-center px-4 py-2 text-xs font-bold text-white bg-indigo-600 rounded-full hover:bg-indigo-500 transition-all duration-300 shadow-[0_0_15px_rgba(79,70,229,0.3)] hover:shadow-[0_0_20px_rgba(79,70,229,0.5)] w-fit"
                                >
                                    Contact Now
                                    <svg xmlns="http://www.w3.org/2000/svg" className="ml-2 w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div className="lg:col-span-2 bg-white/5 p-6 rounded-2xl border border-white/10">
                            ...
                            <div className="flex flex-col space-y-3">
                                <p className="text-lg font-bold text-white">Anjali Chauhan</p>
                                ...
                                <div className="pt-2 flex flex-col space-y-2">
                                    <a href="mailto:contact@anjliben.dev" className="text-xs text-blue-400 hover:underline">aaruba0306@gmail.com</a>
                                    <div className="flex gap-4 pt-1">
                                        <a href="https://github.com/anjalichauhan0306" className="text-slate-400 hover:text-white transition-colors">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/></svg>
                                        </a>
                                        <a href="https://www.linkedin.com/in/anjali-chauhan-22b93430a/" className="text-slate-400 hover:text-white transition-colors">

      ...
      <div className="relative z-10 w-full max-w-250 max-h-[90vh] bg-white/95 backdrop-blur-xl shadow-[0_20px_50px_rgba(0,0,0,0.3)] rounded-[2.5rem] flex flex-col md:flex-row overflow-hidden border border-white/20">
        <div className="w-full md:w-[55%] p-8 md:p-12 flex flex-col justify-center overflow-hidden custom-scrollbar">
          ...
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <button
              className="w-full h-12 bg-linear-to-r from-blue-600 to-indigo-600 text-white font-bold rounded-2xl mt-2 hover:shadow-lg hover:shadow-blue-500/30 transition-all active:scale-[0.97]"
            ...
            <button
              className="w-full h-12 border-2 border-gray-100 rounded-2xl flex items-center justify-center gap-3 hover:bg-gray-50 transition-all font-bold text-gray-700 text-sm"

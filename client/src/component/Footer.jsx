        ...
        <footer className="bg-[#0f172a] w-full max-w-337.5 mx-auto text-white pt-8 lg:pt-12 px-4 sm:px-8 md:px-16 lg:px-28 rounded-tl-[3rem] rounded-tr-[3rem] overflow-hidden border-t border-white/5">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-6 gap-12">
            <div className="lg:col-span-2 space-y-6">
              ...
              <p className="text-sm/6 text-slate-400">
                A modern Learning Management System designed to simplify
                education and track student progress in real-time.
              </p>
            </div>
            ...
            <div className="lg:col-span-2 bg-white/5 p-6 rounded-2xl border border-white/10">
              <h3 className="font-bold text-sm mb-4 text-blue-400 uppercase tracking-wider">
                Developed By
              </h3>
              <div className="flex flex-col space-y-3">
                <p className="text-lg font-bold text-white">Anjali Chauhan</p>
                <p className="text-xs text-slate-400 leading-relaxed">
                  Full-stack developer passionate about building educational
                  tools. Certified in React and GitHub Fundamentals.
                </p>
          ...
          <div className="max-w-7xl mx-auto mt-12 pt-6 border-t border-white/5 flex justify-between items-center">
            <p className="text-slate-500 text-sm">
              © 2026 DevTrack LMS. All rights reserved.
            </p>
          </div>

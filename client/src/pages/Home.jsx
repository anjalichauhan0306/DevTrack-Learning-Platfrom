          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-8">
            <div className="lg:w-1/2 text-center lg:text-left space-y-8">
              ...
              <div className="flex flex-wrap gap-4 justify-center lg:justify-start pt-2">
                <button
                  className="bg-indigo-600 hover:bg-indigo-500 text-white font-bold py-4 px-10 rounded-xl transition-all shadow-[0_0_20px_rgba(79,70,229,0.3)] hover:-translate-y-1 active:scale-95"
                ...
                <button
                  ...
                  className="flex items-center gap-3 px-8 py-4 rounded-xl border border-slate-700 bg-slate-800/40 hover:bg-slate-800 transition-all text-white font-semibold group"
                >
            ...
            <div className="lg:w-1/2 relative flex justify-center">
              <div className="relative w-72 h-72 md:w-96 md:h-96 lg:w-115 lg:h-115">
                ...
                <div className="absolute -top-4 right-0 lg:top-20 lg:-right-6 bg-white p-4 rounded-2xl shadow-2xl flex items-center gap-3 animate-bounce transition-all duration-3000 border border-slate-100">
                  <div className="bg-indigo-100 text-indigo-600 p-2 rounded-xl text-xl">
                    🎓
                  </div>
      ...
      <section className="py-24 max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div
              key={idx}
              className="group p-8 rounded-3xl bg-white border border-slate-100 hover:border-indigo-100 shadow-sm hover:shadow-xl hover:shadow-indigo-500/5 transition-all duration-500"
            >

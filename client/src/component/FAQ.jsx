  ...
  const faqs = [
    {
      ...
      answer:
        "DevTrack is a streamlined Learning Management System designed to simplify education and help developers track their technical growth in real-time.",
    },
    {
      question: "Can I download my progress certificates?",
      answer:
        "Yes! Upon course completion, you can download verified certificates for React, GitHub, and Database tracks to showcase on your portfolio.",
    },
    {
      question: "How do I connect with instructors?",
      answer:
        "DevTrack features a direct connection module where students can get feedback and resolve queries with mentors seamlessly.",
    },
    {
      question: "Is this platform suitable for beginners?",
      answer:
        "Absolutely. The UI is built to be intuitive, ensuring that new developers can focus on learning without any technical distractions.",
    },
  ];
    ...
    <section className="w-full py-16 px-6 bg-white">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-10">
          <h2 className="text-blue-600 font-bold tracking-widest uppercase text-[10px] mb-2">
            Support
          </h2>

    ...
    <section className="w-full py-16 px-4 bg-white">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 items-center">
        <div className="relative flex justify-center lg:justify-start">
           <div className="relative z-0 w-full max-w-125 h-112.5 overflow-hidden rounded-3xl shadow-lg">
            <img
          ...
          <div className="absolute -bottom-6 right-0 md:-right-4 z-10 w-55 md:w-70 bg-white p-1.5 rounded-2xl shadow-2xl">
            <video
         ...
         <div className="flex flex-col space-y-5 lg:pl-6">
          ...
          <p className="text-gray-500 text-base md:text-lg leading-relaxed max-w-lg">
            ...
            education, track progress, and enhance the student-instructor
            connection.
          </p>
          ...
          <div className="grid grid-cols-2 gap-y-4 gap-x-4 pt-2">
            {features.map((item, index) => (
              <div key={index} className="flex items-center gap-2">
                <BsFillPatchCheckFill className="w-5 h-5 text-indigo-600 shrink-0" />
